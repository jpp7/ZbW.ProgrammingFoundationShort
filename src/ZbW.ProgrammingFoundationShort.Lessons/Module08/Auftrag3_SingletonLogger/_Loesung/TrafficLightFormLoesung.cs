...
public sealed class TrafficLightFormLoesung : Form
{
  ...
  public TrafficLightFormLoesung()
  {
    ...
    AppLoggerLoesung.Instance.Log("Ampel initialisiert.");
    UpdateView();
  }
  ...
  private void Timer_Tick(object sender, EventArgs e)
  {
    ...
    AppLoggerLoesung.Instance.Log($"Wechsel zu {TrafficLightLoesung.CurrentColor} um {DateTime.Now:HH:mm:ss}");
    UpdateView();
  }
  ...
  {
    AppLoggerLoesung.Instance.Clear();
    UpdateView();
  }
  ...
  private void UpdateView()
  {
    ...
    foreach (string message in AppLoggerLoesung.Instance.Messages)
